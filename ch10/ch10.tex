...
\begin{figure}[h]
    ...
    \caption[The graph of the vertical deflection of the horizontal beam]{The graph of the vertical deflection of the horizontal beam of Example 10.3. The bending is much less severe than the graph seems to indicate (compare units on the axes); both $x$-and $y$-values are given in feet.}
    \label{fig:fig_10_2}
\end{figure}
...
\caption[Illustration of the nonlinear shooting method for a BVP]{Illustration of the nonlinear shooting method for a BVP: \\
...
shooting method applied to the BVP]{Illustration of the nonlinear
...
\caption[These graphs display the successive differences nonlinear shooting method]{These graphs display the successive differences $\left | y_{k+1}(t)-y_{k}(t) \right |$ for nonlinear shooting method in part (b) of Example 10.4;
...
\begin{figure}[H]
	...
	\caption[Graph of the solution of the beam-deflection problem]{Graph of the solution of the beam-deflection problem of Example 10.6 using $N$=20 subdivisions.}
\end{figure}
...
\begin{figure}[H]
	...
	deflected beam problem]{Plots of differences of finite difference approximated solutions to the
...
\begin{figure}[H]
    ...
    \caption[llustration of a typical function in the space A(P)]{llustration of a typical function in the space $\mathcal{A}(\mathscr{P})$.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[A typical hat function for a certain partition of (0,1)]{A typical hat function for a certain partition of $(0,1)$. Note the (possible) asymmetry.}
\end{figure}
...
\caption[Graph of the right-hand side]{Graph of the right-hand side $f(x)$ of the DE $-u^{\prime \prime}(x)=f(x)$ of Example 10.7.}
\end{figure}
...
\caption[Rayleigh-Ritz solution]{(a) (left) Rayleigh-Ritz solution obtained for Example 10.7(b) shown with
...
\begin{figure}[H]
	...
	\caption[Augustin Louis Cauchy]{\label{first}Augustin Louis Cauchy (1789-1857), French mathematician}
\end{figure}
\columnbreak
\begin{figure}[H]
	\centering
	...
	\caption[Viktor Yakovlevich Bunyakowsky]{\label{second}Viktor Yakovlevich Bunyakowsky (1804-1889), Russian mathematician. }
\end{figure}
\columnbreak
\begin{figure}[H]
	\centering
	...
	\caption[Hermann Amandus Schwarz ]{\label{third}Hermann Amandus Schwarz (1843-1921), German mathematician.}
\end{figure}
\end{multicols}
