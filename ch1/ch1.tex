...
\centering
\begin{tabular}{llll}
\multicolumn{2}{l}{\cellcolor[HTML]{000000}{\color[HTML]{FFFFFF} Color/code}} & \multicolumn{2}{l}{\cellcolor[HTML]{000000}{\color[HTML]{FFFFFF} Plot Style/Code}} \\ \hline
\multicolumn{1}{|l|}{black/k}          & \multicolumn{1}{l|}{red/r}           & \multicolumn{1}{l|}{solid/-}            & \multicolumn{1}{l|}{stars/$*$}             \\ \hline
\multicolumn{1}{|l|}{blue/b}           & \multicolumn{1}{l|}{white/w}         & \multicolumn{1}{l|}{dashed/--}          & \multicolumn{1}{l|}{x-marks/$x$}           \\ \hline
\multicolumn{1}{|l|}{cyan/c}           & \multicolumn{1}{l|}{yellow/y}        & \multicolumn{1}{l|}{dotted/:}           & \multicolumn{1}{l|}{circles/$o$}           \\ \hline
\multicolumn{1}{|l|}{green/g}          & \multicolumn{1}{l|}{}                & \multicolumn{1}{l|}{das-dot/-.}         & \multicolumn{1}{l|}{plus-marks/$+$}        \\ \hline
\multicolumn{1}{|l|}{magenta/m}        & \multicolumn{1}{l|}{}                & \multicolumn{1}{l|}{points/.}           & \multicolumn{1}{l|}{pentacles/$p$}         \\ \hline
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth,height=55mm]{fig17}v
\end{figure}
...
section.  }
\centering
\begin{tabular}{>{\columncolor{lightgray}}c>{\columncolor{white}}c>{\columncolor{lightgray}}c}
...
\item Use a while loop to add all of the odd numbers up: 1 + 3 + 5 + 7 + \ldots until the sum exceeds 5 
